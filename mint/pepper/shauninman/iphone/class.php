...
function SI_iPhone_outputBuffer($buffer)
{
	$buffer = str_replace('SI.Mint.staggerPaneLoading(true);', 'SI.Mint.staggerPaneLoading(false);', $buffer);
	return $buffer;
}
...
HTML;
			...
			if (!isset($this->Mint->tmp['headTags']))
			{
				...
				{
					ob_start('SI_iPhone_outputBuffer');
				}
			}
		}
	}
